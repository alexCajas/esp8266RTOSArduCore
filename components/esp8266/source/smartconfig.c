...
esp_err_t esp_smartconfig_start(const smartconfig_start_config_t* config,sc_callback_t cb)
{
    esp_err_t err = ESP_OK;
    ...
    err = esp_event_handler_register(SC_EVENT, SC_EVENT_SEND_ACK_DONE, cb, NULL);
